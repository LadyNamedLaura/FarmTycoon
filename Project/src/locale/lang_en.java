...
public class lang_en extends ListResourceBundle {
	...
	private Object[][] contents = {
			...
			{ "FACTORY_WORKING", "the factory is running at full power"},
			...
			{ "Factory_BREADFACTORY_IDLE","the breadfactory is built "},
			{ "Factory_TRUFFLEFACTORY_IDLE","the trufflefactory is built "},
